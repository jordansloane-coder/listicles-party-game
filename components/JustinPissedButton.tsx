...
// Novelty tap counter — purely for fun, no effect on scoring. A little
// fireworks burst per tap, tallied and shown again on the final screen.
export default function JustinPissedButton({ count, onTap }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 py-2">
      <button
        onClick={handleClick}
        className="relative overflow-visible rounded-full bg-gradient-to-r from-sun to-hot text-white font-extrabold px-5 py-3 shadow-lg active:scale-95 transition-transform"
      >
        🎉 Justin got pissed! 🎉
